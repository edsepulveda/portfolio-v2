      ...
      <div className='py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6'>
        <div className='text-center lg:mb-16 mb-8'>
          ...
          <p className='font-light text-sm md:text-xl text-white'>
            Aqui es donde se encuentran mis ultimos projectos que he realizado
          </p>
        </div>
          ...
          {ProjectsV2.map((item) => (
            <div key={item.id} className='overflow-hidden rounded-lg'>
              ...
              <div className='p-4 sm:p-6 text-white'>
                <div className='mt-0.5 font-bold text-2xl mb-5'>
                  {item.title}
                </div>
              ...
              <div className='flex flex-col text-center gap-5 md:flex-row justify-center p-6'>
                <a
                  className='px-12 py-3 border-none text-lg font-semibold rounded shadow-lg border focus:outline-transparent bg-[#F7B42C] hover:scale-110 transition duration-500'
                  href={item.demo}
                  target='_blank'
                >
                  Demo
                ...
                <a
                  className='px-12 py-3 border-none text-lg font-semibold rounded shadow-lg border focus:outline-transparent bg-[#FC575E] hover:scale-110 transition duration-500'
                  href={item.code}
                  target='_blank'
                >
                  Code
